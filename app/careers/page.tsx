...
import { Briefcase, Calendar, Clock, MapPin, Target, TrendingUp } from 'lucide-react';
        ...
        <div className="xl:max-w-6xl w-auto mx-auto xl:py-28 md:py-16 py-10 xl:px-0 px-10">
          ...
          <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-x-4 lg:gap-x-8 gap-y-4 lg:pb-24 pb-10 max-w-lg mx-auto md:max-w-3xl lg:max-w-full">
            <div className="p-8 group rounded-2xl transition-all duration-500 bg-white hover:shadow-md">
              ...
              <h4 className="text-gray-900 text-lg font-semibold leading-7 mb-3 max-lg:text-center">Objectifs clairs</h4>
              <p className="text-gray-500 text-sm font-normal leading-5 max-lg:text-center">Des objectifs clairs et des indicateurs de performance pour vous aider à atteindre vos objectifs.</p>
            </div>
            <div className="p-8 group rounded-2xl transition-all duration-500 bg-white hover:shadow-md">
              <div className="w-20 h-20 bg-green-50 rounded-xl flex items-center justify-center mb-5 max-lg:mx-auto transition-all duration-500">
              ...
              <p className="text-gray-500 text-sm font-normal leading-5 max-lg:text-center">Des horaires flexibles pour vous aider à gérer vos priorités.</p>
            </div>
            <div className="p-8 group rounded-2xl transition-all duration-500 bg-white hover:shadow-md">
              <div className="w-20 h-20 bg-green-50 rounded-xl flex items-center justify-center mb-5 max-lg:mx-auto transition-all duration-500">
                <MapPin className="w-8 h-8 text-green-600" />
              </div>
              <h4 className="text-gray-900 text-lg font-semibold leading-7 mb-3 max-lg:text-center">Location</h4>
              <p className="text-gray-500 text-sm font-normal leading-5 max-lg:text-center">Un emplacement idéal pour vous aider à concilier votre vie personnelle et professionnelle.</p>
            </div>
          </div>
